/*
The .sort() method in JavaScript is used to sort the elements of an array in place. It modifies the original array and returns the sorted array. 

By default, .sort() converts the elements to strings and sorts them in ascending order based on their UTF-16 code unit values. This default behavior may not always work as expected for numbers or custom sorting needs.
...
To sort numbers correctly, you need to provide a comparison function to the .sort() method. This function determines the order of elements based on their numeric values.
*/
