...
How Does it Work?
Object Creation: 
When you create an object in JavaScript (using a constructor function, object literal, or class), 
it has a hidden link to another object, called its prototype.

Prototype Chain: 
If you try to access a property or method on an object and it doesn't exist on that object, 
JavaScript will look for it on the object's prototype. 
...
Why Use Prototypes?
Memory Efficiency: Methods and properties defined on the prototype are shared among all instances. 
This reduces memory usage because they are not duplicated for each instance.
...
Prototype vs proto
prototype: A property of constructor functions. It's used to define properties and methods that should be shared by all instances 
of a constructor.
